...
rustPlatform.buildRustPackage rec {
  ...
  src = fetchFromGitHub {
    ...
    repo = pname;
    rev = "v${version}";
    sha256 = "sha256:167j2j629nf5q3kfnvldchzbki90p905hmkzhf8f392xj62ar8d5";
  };
  cargoSha256 = "sha256:0mkg1g9nf85w4vnyy9riala64rjsshbszrz46k1bap073z7hbr83";
  ...
  installCheckPhase = ''
    echo ${lib.escapeShellArg ''
           ...
           ''} > hello-world.ts
    DENO_DIR=/tmp/deno $out/bin/deno run hello-world.ts
  '';
