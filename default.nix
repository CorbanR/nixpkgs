...
let
  ...
  darwinPlatformPackages = {
    ...
    dart_beta = callPackage ./pkgs/development/interpreters/dart {version="2.10.0-110.5.beta";};
    dart_dev = callPackage ./pkgs/development/interpreters/dart {version="2.10.0-110.0.dev";};
