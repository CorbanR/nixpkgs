...
let
  ...
  darwinPlatformPackages = {
    ...
    dart_beta = callPackage ./pkgs/development/interpreters/dart {version="2.11.0-213.5.beta";};
    dart_dev = callPackage ./pkgs/development/interpreters/dart {version="2.12.0-13.0.dev";};
